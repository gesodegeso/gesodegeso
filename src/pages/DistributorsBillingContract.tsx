...
export default class DistributorsBillingContract extends Component {
  render() {
    return (
      <>
        ...
        <Container id="contents">
          ...
          <Card bg="Light" className="form_input">
            <Card.Body>
              ...
              {/* <Card.Subtitle className="mb-2 text-muted">Card Subtitle</Card.Subtitle> */}
              <DistributorsBillingContractOptions />
            </Card.Body>
          </Card>
        </Container>
        <Footer />
...
DistributorsBillingContract.propTypes = {
...
function DistributorsBillingContractOptions() {
